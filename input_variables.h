...
float jet_pt_max_cut = 300.0; // jet max pT cut
...
TString jet_trigger;
TString PbPb_jet_trigger = "HLT_HIAK4CaloJet80_v1"; // HLT_HIPuAK4CaloJet80Eta5p1_v1
...
TString PbPb_jet_collection = "ak4PFJetAnalyzer"; // akCs4PFJetAnalyzer //PF jets with CS background subtraction
...
TString PbPb_JEC_file = "Spring18_ppRef5TeV_V6_MC_L2Relative_AK4PF.txt"; // Autumn18_HI_V8_MC_L2Relative_AK4PF.txt// for PbPb ak4PF jets
TString PbPb_JEC_file_data = "Spring18_ppRef5TeV_V6_DATA_L2L3Residual_AK4PF.txt"; // Autumn18_HI_V8_DATA_L2L3Residual_AK4PF.txt // residual for PbPb ak4PF jets for data
